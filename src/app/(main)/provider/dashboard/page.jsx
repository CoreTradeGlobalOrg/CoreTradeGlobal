...
const ProviderDashboard = dynamic(
  () => import('@/presentation/components/features/provider/ProviderDashboard/ProviderDashboard').then(m => ({ default: m.ProviderDashboard })),
  { loading: () => <DashboardSkeleton />, ssr: false }
);
const ActiveShipmentsTab = dynamic(
  () => import('@/presentation/components/features/provider/ActiveShipmentsTab').then(m => ({ default: m.ActiveShipmentsTab })),
  { loading: () => <DashboardSkeleton />, ssr: false }
);
const InsuranceCoverageTab = dynamic(
  () => import('@/presentation/components/features/provider/InsuranceCoverageTab').then(m => ({ default: m.InsuranceCoverageTab })),
  { loading: () => <DashboardSkeleton />, ssr: false }
);
