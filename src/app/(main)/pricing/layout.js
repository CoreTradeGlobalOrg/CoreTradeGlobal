...
export const metadata = {
  ...
  description:
    'CoreTradeGlobal is completely free, with no commissions, no membership fees, and no hidden costs. Optional advertising placements let brands showcase to a qualified global B2B audience.',
  ...
  openGraph: {
    ...
    title: 'Pricing: Completely Free B2B Trading | CoreTradeGlobal',
    description:
      'CoreTradeGlobal is completely free, with no commissions and no fees. Explore optional advertising spotlights to grow your brand across a qualified global B2B audience.',
