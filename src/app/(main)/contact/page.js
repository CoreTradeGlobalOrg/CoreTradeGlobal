    ...
    return (
        <aside className="relative overflow-hidden rounded-[20px] p-8 border border-[rgba(255,255,255,0.08)] bg-gradient-to-br from-[rgba(26,28,32,0.6)] to-[rgba(15,27,43,0.8)]">
            ...
            <a
                ...
                className="flex items-center gap-3 w-full px-4 py-3.5 rounded-xl bg-[#25D366] hover:bg-[#1EBE5B] transition-colors no-underline font-semibold shadow-[0_2px_8px_rgba(37,211,102,0.12)]"
            >
