        ...
        <div className="footer-grid">
          ...
          <div className="footer-col brand-col">
            ...
            <div className="flex flex-col gap-2 mt-4 text-sm text-gray-400">
              ...
              <a href="tel:+48789603272" className="hover:text-[#FFD700] transition-colors !flex items-center gap-2">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                <span>+48 789 603 272</span>
              </a>
          ...
          <div className="footer-col">
            ...
            <div className="flex items-center gap-5 mt-4">
              <a
                ...
                aria-label="CoreTradeGlobal on X (Twitter)"
              >
              ...
              <a
                ...
                aria-label="CoreTradeGlobal on LinkedIn"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
              ...
              <a
                ...
                aria-label="CoreTradeGlobal on Facebook"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
