/**
 * GlobeCanvasFallback — main-thread R3F implementation.
 *
 * Rendered by GlobeCanvas.jsx when the browser lacks OffscreenCanvas +
 * transferControlToOffscreen (mostly Safari < 16.4 by early 2026). All
 * modern engines take the worker path in GlobeCanvas; this file exists
 * only for that fallback.
 *
 * 3D animated globe using Three.js — rotating earth with land points
 * (from a specular map) and animated trade routes.
 */
