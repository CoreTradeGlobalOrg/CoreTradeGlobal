    ...
    >
      ...
      <div>
        ...
        <select
          ...
          className="w-full bg-[#0D1822] border border-[#2A3B52] text-white text-sm rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#FFD700] disabled:opacity-50"
        >
