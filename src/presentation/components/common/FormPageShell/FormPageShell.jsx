 ...
 *   backHref {string}   - Optional back-link target.
...
export function FormPageShell({ title, backHref, backLabel = 'Back', children }) {
  return (
    <main className="min-h-screen bg-radial-navy pt-[calc(var(--navbar-height)+24px)] pb-16">
      <div className="max-w-2xl mx-auto px-4">
        {backHref && (
          <Link
            href={backHref}
            className="inline-flex items-center gap-2 text-[#FFD700] hover:text-white text-sm font-semibold mb-4 transition-colors"
          >
