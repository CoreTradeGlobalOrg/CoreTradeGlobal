...
export const registerSchema = z
  .object({
    ...
    // Password policy — see PasswordChecklist for the user-facing copy;
    // kept minimal (length + 1 digit) after user feedback that the old
    // 4-rule composition policy caused most sign-ups to hit an error
    // wall on the first attempt.
    password: z
      .string()
