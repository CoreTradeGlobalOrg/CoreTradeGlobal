...
export const AD_TIERS = [
  {
    ...
    price: '$100',
    priceSuffix: '/week',
    desc: 'Your product lands in the desktop homepage hero, the mobile hero ad row, AND the top of the B2B product directory — every visitor sees it before they scroll.',
    features: [
      'Homepage hero spotlight (desktop top-left card + mobile ad card)',
      'Top-of-directory placement across all product searches',
  ...
  },
  {
    ...
    price: '$100',
    priceSuffix: '/week',
    desc: 'Dedicated brand card on the mobile homepage ad row — the first thing every mobile visitor sees the moment they land on the platform, right under the Add Product / Add Request CTAs.',
    features: [
      'Prime mobile homepage ad card, above the fold',
      'Logo, company name, tagline + Visit CTA in one card',
      '3,000+ daily visitors landing directly on the platform',
      'Mobile-first placement — 60%+ of B2B traffic comes from phones',
    ],
